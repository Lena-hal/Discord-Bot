...
def story_gen():
    ...
    4: { # Pokemon
      "She/her": {
          ...
          "konec": ["ale když viděla že se před ní objevila Lopunny ztratila kontrolu nad svím tělem a udělala nekalé věci :(.", "ale když viděla že se před ní objevila Gardervoir ztratila kontrolu nad svím tělem a udělala nekalé věci :(.", "ale když viděla že se před ní objevil Machamp ztratila kontrolu nad svím tělem a udělala nekalé věci :(.", "ale když viděla že se před ní objevil Vaporeon ztratila kontrolu nad svím tělem a udělala nekalé věci :(.", "ale když viděla že se před ní objevil Leafeon tak si řekla ´´Zakra to je cool pokemon!", "ale když viděla že se před ní objevil Incineroar tak si řekla ´´Zakra to je cool pokemon!´´", "ale když viděla že se před ní náhle objevil Pokemoní bůh Arceus tak si řekla ´´DOPRDELE BŮH EXISTUJE A JE TU ABY SOUDIL MÉ HŘÍCHY!!!!!!´´", "ale když viděla že se před ní objevil Tandemaus tak si řekla ´´No to je fakt boring Pokemon,,,´´"]
      },
      "He/him": {
          ...
          "konec": ["ale když viděl že se před ním objevila Lopunny ztratil kontrolu nad svím tělem a udělal nekalé věci :(.", "ale když viděl že se před ním objevila Gardervoir ztratil kontrolu nad svím tělem a udělal nekalé věci :(.", "ale když viděl že se před ním objevil Machamp ztratil kontrolu nad svím tělem a udělal nekalé věci :(.", "ale když viděl že se před ním objevil Vaporeon ztratil kontrolu nad svím tělem a udělal nekalé věci :(.", "ale když viděl že se před nim objevil Leafeon tak si řekl ´´Zakra to je cool pokemon!", "ale když viděl že se před nim objevil Incineroar tak si řekl ´´Zakra to je cool pokemon!´´", "ale když viděl že se před nim náhle objevil Pokemoní bůh Arceus tak si řekl ´´DOPRDELE BŮH EXISTUJE A JE TU ABY SOUDIL MÉ HŘÍCHY!!!!!!´´", "ale když viděl že se před nim objevil Tandemaus tak si řekl ´´No to je fakt boring Pokemon...´´"]
      },
    },
    5: { # Vlaky
      "She/her": {
    ...
    postava = {
        ...
        "He/him":["Šéf", "Archie", "Péťa", "Džimmy", "Fanoušek", "Skyf", "Ol*a", "Kiki", "Pavlí"]
        }
